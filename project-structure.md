...
- **Projects**: Setup plus seven browser projects: `super_admin`, `admin`, `finance_admin`, `volunteer`, `unoriented_volunteer`, `unauthenticated`, and `kalakriti_phase2`. The one-worker `kalakriti_phase2` project owns event-day flows, public schedule privacy, and singleton live-Edition races so they cannot compete for the database-wide live slot. The race and public schedule tests reset the shared 2186 fixture before starting; public schedule keeps its unoriented-volunteer authentication with a spec-level override.
