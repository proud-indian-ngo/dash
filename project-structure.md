...
| `routes/_app/kalakriti/$year/entries.tsx`, `entries/` | Center-scoped Session summary and per-Session individual Competition Entry registration with live eligibility, limit, overlap, and capacity validation |
