...
function expandSeriesEvent(
  ...
  // Edits like "all" / "this and following" can shift the series DTSTART or UNTIL
  // such that an exception's startTime or originalDate no longer matches any
  // occurrence generated by the current RRULE. Those exceptions are still part
  // of the series and would become invisible anywhere else, so show them here.
  for (const exc of event.exceptions) {
    if (exc.cancelledAt) {
      continue;
    }
