...
describe("Kalakriti Student policy", () => {
  ...
  it.each([
    ["draft", true, false, 1, "edition_closed"],
    ["registration_open", false, false, 1, "center_closed"],
    ["registration_open", true, true, 0, "loading"],
    ["registration_open", true, false, 0, "missing_configuration"],
