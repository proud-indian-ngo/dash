...
| Kalakriti Edition access, registration, lifecycle, schedule, audit, exports, volunteer yearly IDs, or detail-sheet JSON QR codes | `docs/architecture/kalakriti-registration.md` |
