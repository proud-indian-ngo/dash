...
- **Page objects**: Use page objects from `packages/e2e/pages/` for reimbursement, advance-payment, and user tests (`ReimbursementPage`, `AdvancePaymentPage`, `ListPage`). Compose `ListPage`, `RequestFormPage`, and `ApprovalDetailPage` for new domains.
...
- DO: Use page objects from `packages/e2e/pages/` when testing reimbursements or advance payments.
