...
| Kalakriti Edition access, registration, lifecycle, schedule, audit, exports, volunteer yearly IDs, detail-sheet JSON QR codes, Center transport, or event-day operations | `docs/architecture/kalakriti-registration.md` |
