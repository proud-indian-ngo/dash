  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "transition-[width] duration-200 ease-(--ease-out-expo) relative w-(--sidebar-width) bg-transparent",
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-(--ease-out-expo) data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex",
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-sidebar-border focus-visible:bg-sidebar/30 focus-visible:ring-sidebar-ring focus-visible:ring-offset-sidebar absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear focus-visible:ring-2 focus-visible:ring-offset-2 group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] focus-visible:after:bg-sidebar-border sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "text-sidebar-foreground/70 ring-sidebar-ring h-8 rounded-none px-2 text-xs transition-[margin,opacity] duration-200 ease-(--ease-out-expo) group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 flex shrink-0 items-center outline-hidden [&>svg]:shrink-0",
          className
        ),
      },
      props
...
function SidebarMenuButton({
  ...
  const comp = useRender({
    ...
    render: !tooltip
      ? render
      : (props) => <TooltipTrigger render={render} {...props} />,
    state: {
