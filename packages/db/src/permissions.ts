export const PERMISSIONS = [
  // ── Requests (reimbursements, advance payments, vendor payments) ──
  {
    id: "requests.create",
  ...
  },
  {
    ...
    category: "requests",
    description: "See your own submitted requests",
  },
  {
    id: "requests.view_all",
    name: "View All Requests",
    category: "requests",
    description: "See all users' requests",
  },
  {
    id: "requests.edit_own",
    name: "Edit Own Requests",
    category: "requests",
    description: "Edit your own pending requests",
  },
  {
    id: "requests.edit_all",
    name: "Edit All Requests",
    category: "requests",
    description: "Edit any user's pending requests",
  },
  {
    id: "requests.delete_own",
    name: "Delete Own Requests",
    category: "requests",
    description: "Delete your own pending requests",
  },
  {
    id: "requests.delete_all",
    name: "Delete All Requests",
    category: "requests",
    description: "Delete any user's requests",
  },
  {
    id: "requests.approve",
  ...
  },
  {
    ...
    category: "requests",
    description: "Export request data to CSV",
  },
