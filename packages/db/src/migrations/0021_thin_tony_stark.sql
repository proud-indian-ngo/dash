...
ALTER TABLE "user" ALTER COLUMN "role" SET DEFAULT 'volunteer';--> statement-breakpoint
...
INSERT INTO "role" ("id", "name", "is_system", "created_at", "updated_at") VALUES ('admin', 'Admin', true, now(), now()), ('volunteer', 'Volunteer', true, now(), now()) ON CONFLICT DO NOTHING;--> statement-breakpoint
