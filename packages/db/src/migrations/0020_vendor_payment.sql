...
CREATE TYPE "public"."vendor_payment_status" AS ENUM('draft', 'pending', 'approved', 'rejected');--> statement-breakpoint
CREATE TABLE "vendor" (
...
CREATE INDEX "vendor_payment_line_item_vendorPaymentId_idx" ON "vendor_payment_line_item" USING btree ("vendor_payment_id");--> statement-breakpoint
...
CREATE INDEX "vendor_payment_history_vendorPaymentId_idx" ON "vendor_payment_history" USING btree ("vendor_payment_id");
