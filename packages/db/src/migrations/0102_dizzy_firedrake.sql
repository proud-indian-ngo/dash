ALTER TYPE "public"."kalakriti_responsibility" ADD VALUE 'escort_volunteer';--> statement-breakpoint
ALTER TYPE "public"."kalakriti_responsibility" ADD VALUE 'transit_volunteer';--> statement-breakpoint
