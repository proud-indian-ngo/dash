...
describe("kalakritiCenter commands", () => {
  ...
  it.each([0, 1])(
    "rejects closing participation registration while a Student has %i Entries",
    async (count) => {
      const closingCenter = {
        ...center,
        competitionEntryRegistrationEnabled: true,
  ...
  it("allows closing participation registration when all Students have at least two Entries", async () => {
    const closingCenter = {
      ...center,
      competitionEntryRegistrationEnabled: true,
    };
  ...
  it("allows closing participation when every Student meets the Edition minimum", async () => {
    const closingCenter = {
      ...center,
      competitionEntryRegistrationEnabled: true,
    };
  ...
  it.each([0, 1])(
    "rejects bulk locking while a Student has %i Entries",
    async (count) => {
      const closingCenter = {
        ...center,
        competitionEntryRegistrationEnabled: true,
