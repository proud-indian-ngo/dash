...
const dropdownArrowVariants = cva(
  cn(
    "inline-flex items-center justify-center rounded-none font-medium text-foreground text-sm transition-colors disabled:pointer-events-none disabled:opacity-50"
  ),
  {
    defaultVariants: {
      size: "sm",
