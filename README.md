...
| Kalakriti Scan | Role-aware sidebar tabs cover Center transport, volunteer check-in, meals, and Competition attendance. Pickup allows absentees; later transport stages require every traveler. Meals require pickup or check-in; attendance requires pickup and a valid Competition session. Students and Centers show transport status in their tables. |
