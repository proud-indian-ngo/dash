...
| Kalakriti Scan | Authorized staff scan from a sidebar modal, with a Center selector only when needed. Pickup can finish with absentees; later stages require every picked-up Student. Students and Centers show their transport status directly in their tables. |
