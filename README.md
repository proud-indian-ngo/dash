...
| Kalakriti Editions | Create yearly Kalakriti workspaces with Edition-scoped access, persistent external identities, registration workflows, assignment-scoped dashboards, and administrator or assigned-Lead audit trails |
