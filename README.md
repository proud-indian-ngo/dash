...
| Kalakriti Guests and Judges | Manage Edition-bound non-login attendees with required name/phone and optional email. Assign judges to multiple competitions; Overall Events Leads can edit existing Judges and their assignments, while other Event Heads have scoped read access and Volunteer Coordinators can view both rosters. Guests and judges use QR/yearly-ID check-in before breakfast or lunch. |
